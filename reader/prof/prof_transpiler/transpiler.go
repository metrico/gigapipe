...
func populateTypeId(script *prof_parser.Script, tId *shared2.TypeId) {
	script.Selectors = append(script.Selectors, []prof_parser.Selector{
		{"__name__", "=", prof_parser.Str{"`" + tId.Tp + "`"}},
		{"__period_type__", "=", prof_parser.Str{"`" + tId.PeriodType + "`"}},
		{"__period_unit__", "=", prof_parser.Str{"`" + tId.PeriodUnit + "`"}},
		{"__sample_type__", "=", prof_parser.Str{"`" + tId.SampleType + "`"}},
		{"__sample_unit__", "=", prof_parser.Str{"`" + tId.SampleUnit + "`"}},
	}...)
}

...
func Plan(script *parser.LogQLScript, finalize bool) (shared.SQLRequestPlanner, error) {
...
func (p *planner) planDrop(i int, ppl *parser.StrSelectorPipeline) error {
...
func (p *planner) planLRA(lra *parser.LRAOrUnwrap) error {
...
func (p *planner) planUnwrapFn(lra *parser.LRAOrUnwrap) error {
...
func (p *planner) planByWithout(byWithout ...*parser.ByOrWithout) error {
	var _byWithout *parser.ByOrWithout
...
func (p *planner) planAgg(agg *parser.AggOperator, withLabels bool) error {
...
func (p *planner) planTopK(topK *parser.TopK) error {
...
func (p *planner) planQuantileOverTime(script *parser.QuantileOverTime) error {
...
func (p *planner) planComparison(script *parser.Comparison) error {
	if script == nil {
		return nil
	}
...
func (p *planner) planLineFormat(ppl *parser.StrSelectorPipeline) error {
...
func (p *planner) planLabelFilter(ppl *parser.StrSelectorPipeline, idx int) error {
...
func (p *planner) planLineFilter(ppl *parser.StrSelectorPipeline) error {
...
func (p *planner) planUnwrap(ppl *parser.StrSelectorPipeline) error {
...
func (p *planner) planParser(ppl *parser.StrSelectorPipeline) error {
	var (
		labels []string
		vals   []string
	)
...
func getPipeline(script *parser.LogQLScript) []parser.StrSelectorPipeline {
	return getStreamSelector(script).Pipelines
}

func getStreamSelector(script *parser.LogQLScript) *parser.StrSelector {
...
func getLabelsAndValuesFromDrop(drop *parser.Drop) ([]string, []string, error) {

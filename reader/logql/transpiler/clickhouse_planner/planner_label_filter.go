...
func (s *LabelFilterPlanner) makeSqlCond(ctx *shared.PlannerContext,
	expr *parser.LabelFilter) (sql.SQLCondition, error) {
	var (
...
func (s *LabelFilterPlanner) makeSimpleSqlCond(ctx *shared.PlannerContext, expr *parser.SimpleLabelFilter) (sql.SQLCondition, error) {
...
func (s *LabelFilterPlanner) makeSimpleStrSqlCond(_ *shared.PlannerContext, expr *parser.SimpleLabelFilter) (sql.SQLCondition, error) {
...
func (s *LabelFilterPlanner) makeSimpleNumSqlCond(_ *shared.PlannerContext, expr *parser.SimpleLabelFilter) (sql.SQLCondition, error) {
	var label sql.SQLObject = sql.NewRawObject(fmt.Sprintf("labels['%s']", expr.Label.Name))
	if s.LabelValGetter != nil {
		label = s.LabelValGetter(expr.Label.Name)
	}
